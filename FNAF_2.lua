...
local Animatronics = {
{Name = "BalloonBoy", Path = workspace.Animatronics.BalloonBoy.BalloonBoyNPC, Color = Color3.new(0.537255, 0.125490, 0.529412)},
{Name = "Freddy", Path = workspace.Animatronics.Freddy.FreddyNPC, Color = Color3.new(0.341176, 0.184314, 0.066667)},
...
{Name = "Mangle", Path = workspace.Animatronics.Mangle.MangleNPC, Color = Color3.new(0.325490, 0.282353, 0.325490)},
{Name = "Puppet", Path = workspace.Animatronics.Puppet.PuppetNPC, Color = Color3.new(0.145098, 0.098039, 0.329412)},
{Name = "ToyBonnie", Path = workspace.Animatronics.ToyBonnie.ToyBonnieNPC, Color = Color3.new(0.454902, 0.733333, 0.945098)},
{Name = "ToyChica", Path = workspace.Animatronics.ToyChica.ToyChicaNPC, Color = Color3.new(0.988235, 0.909804, 0.392157)},
{Name = "ToyFreddy", Path = workspace.Animatronics.ToyFreddy.ToyFreddyNPC, Color = Color3.new(0.670588, 0.439216, 0.160784)},
...
KeybindInfo.Text = "Press 'P' to toggle all • RightShift to hide"
